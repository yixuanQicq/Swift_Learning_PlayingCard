...
class PlayingCardView: UIView {
    ...
    private var cornerString: NSAttributedString{
        return centeredAttributedString(rankingString+"\n"+suit, fontSize: cornerFontSize)
    }
    
    private lazy var upperLetCornerLabel : UILabel = createCornerLabel()
    ...
    override func layoutSubviews() {
        ...
        configureCornerLabel(upperLetCornerLabel)
        upperLetCornerLabel.frame.origin = bounds.origin.offsetBy(dx: cornerOffset, dy: cornerOffset)
...
//        path.fill()
        ...
        // all drawings are within the roundedRect
        roundedRect.addClip()
...
extension PlayingCardView{
    private struct SizeRatio {
        ...
        static let cornerOffsetToConerRadius: CGFloat = 0.33
    ...
    private var cornerOffset: CGFloat{
        return cornerRadius * SizeRatio.cornerOffsetToConerRadius
    }
